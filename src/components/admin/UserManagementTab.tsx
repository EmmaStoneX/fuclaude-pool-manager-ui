...
const UserManagementTab: React.FC = () => {
    ...
    const getProviderBadge = (provider: AuthProvider) => {
        ...
        return (
            <span style={{
                ...
                fontSize: '11px',
                fontWeight: 500,
                background: isGitHub ? '#24292e' : isEmail ? '#10b981' : '#0078D4',
                color: 'white',
                borderRadius: '4px'
            }}>
                {isGitHub && (
                ...
                {isGitHub ? 'GitHub' : isEmail ? 'Email' : 'LinuxDO'}
            </span>
        );
    };
    ...
    const emailCount = usersResponse?.email_count ?? 0;
    ...
    return (
        <div className="user-management-container">
            ...
            <div className="stats-row">
                ...
                <div className="stat-item email" title="Email 用户">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                    <span className="stat-value">{emailCount}</span>
                </div>
                <div className="stat-divider"></div>
            ...
            <div className="settings-section" style={{
                ...
                <div className="settings-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '16px' }}>
                    ...
                    <ToggleSwitch
                        label="允许邮箱一键登录"
                        checked={settings.login_email_enabled}
                        onChange={(val) => updateSetting('login_email_enabled', val)}
                        disabled={settingsLoading}
                    />
                </div>
                <p style={{ margin: '8px 0 0 0', fontSize: '12px', color: '#6b7280' }}>
                    关闭开关后，将在对应入口显示“站点维护中”，此时对于 OAuth 登录仅允许对应的管理员白名单账号登入，邮箱账号则全部拦截。
                </p>
            </div>
            ...
            <style>{`
                ...
                .stat-item.email .stat-value { color: #10b981; }
